  ...
  try {
    ...
    res.status(200).json({
      ...
      filters: {
        ...
        year: validatedYear,
        from_date: `${validatedYear}-${validatedMonth
          .toString()
          .padStart(2, "0")}-01`,
        to_date: `${validatedYear}-${validatedMonth
          .toString()
